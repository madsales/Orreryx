...
const STREAMS = [
  {
    ...
    key: 'conflict',
    url: gdelt('(war OR military OR attack OR bombing OR airstrike OR coup OR conflict OR rebel OR missile OR troops OR soldier OR armed OR siege OR offensive OR ceasefire OR frontline OR artillery OR drone%20strike OR sniper OR hostage OR insurgent OR paramilitary)', 50),
  },
  {
