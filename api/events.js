...
const STREAMS = [
  ...
  {
    key: 'india',
    query: 'India OR Modi OR Delhi OR Mumbai OR Bangalore OR Chennai OR Kolkata OR Hyderabad OR BSE OR NSE OR Sensex OR Nifty OR RBI OR "Reserve Bank of India" OR BJP OR Congress OR Kashmir OR Gujarat OR Maharashtra OR "Indian Army" OR ISRO',
    max: 25,
  },
  {
    key: 'asia_pacific',
    query: 'Japan OR Korea OR Australia OR Indonesia OR Malaysia OR Vietnam OR Thailand OR Philippines OR Bangladesh OR "Sri Lanka" OR Nepal OR Singapore OR "South Asia" OR "Southeast Asia" OR "Asia Pacific" OR ASEAN OR "Pacific Ocean"',
    max: 20,
  },
];
...
const GEO = [
  ...
  [' rbi ',         [19.0,  72.8,  'Mumbai, India']],
  ['isro',          [13.1,  80.3,  'Chennai, India']],
